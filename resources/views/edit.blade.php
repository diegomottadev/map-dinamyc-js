    ...
    <div class="col-md-6">
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <button class="btn btn-block btn-primary" id="btn-update">Modificar</button>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    $( document ).ready(function(){
        ...
        const changeThemeBootstrapSelect = () => {
            $("#country").select2({
        ...
        const changeInitMap = () =>{
            ...
            map = new mapboxgl.Map({
                ...
                center: [address.longitud,address.latitud],
                zoom: 6
            });
            ...
            geojson = {
                ...
                'features': [{
                    ...
                    'geometry': {
                        'type': 'Point',
                        'coordinates': [address.longitud,address.latitud]
                    }
                }]
            };
            ...
            map.on('load',function(){
                ...
                geojson.features[0].geometry.coordinates = [address.longitud,address.latitud];
        ...
        $("#lat").val(address.latitud);
        $("#lon").val(address.longitud);

        changeThemeBootstrapSelect();
